...
-- Tiempo de generación: 03-05-2018 a las 08:49:26
...
(56, '9632-POI', 'ZZZASDCF7852369', 3, 13),
(59, '3212-JBP', 'VVZZZWER784125', 5, 13);
...
--
ALTER TABLE `Tipo`
  MODIFY `codTipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `Vehiculo`
--
ALTER TABLE `Vehiculo`
  MODIFY `codVeh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
--
